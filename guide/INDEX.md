...
| [task_003](task_003/plan.md) | 进行中 | P0 | [task_003_feedback.md](../feedback/task_003_feedback.md)（首验需整改） | 2026-08-28 首验：视觉/基础回归通过；须整改 error/retry、O(batch) 与有界投影、结构化 action target 和证据矩阵。 |
