...
EVENT_PLAN_COMPLETION_DEFERRED = "plan_completion_deferred"
EVENT_STEP_BUDGET_EXTENDED = "step_budget_extended"
EVENT_STEP_BUDGET_FINALIZING = "step_budget_finalizing"
...
REQUIRED_EVENT_TYPES: tuple[str, ...] = (
    ...
    EVENT_TOOL_FINISHED,
    EVENT_PLAN_UPDATED,
    EVENT_PLAN_COMPLETION_DEFERRED,
    EVENT_STEP_BUDGET_EXTENDED,
    EVENT_STEP_BUDGET_FINALIZING,
